...
from api.routers import auth_routers, oauth_routers, safety_alert_routers, transit_routers, commute_routers, traffic_routers
...
api_router.include_router(traffic_routers.router)
